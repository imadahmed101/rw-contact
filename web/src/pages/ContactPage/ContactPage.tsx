...
const ContactPage = () => {
  ...
  return (
    <>
      ...
      <h1>ContactPage</h1>
      <Toaster/>
      <Form formMethods={formMethods} onSubmit={onSubmit} error={error} className='flex flex-col bg-gray-300 max-w-[350px] p-4 mx-auto rounded-md'>
        ...
        <SelectField name='courses' multiple={false}>
          <option>MERN</option>
